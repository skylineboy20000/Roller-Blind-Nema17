...
String APpw = "setup123";           //Hardcoded password for access point
...
AccelStepper myStepper(stepsPerRevolution, D1, D2, D3, D4); //Initiate stepper driver
